...
const CollapsedMenu = ({ onClick }: Props) => {
	return (
			...
			<div className='p-5 bg-white border rounded shadow-sm'>
				...
				<nav>
					<ul className='space-y-4'>
						<NavLink path='/' content='Product' collapsed />
						<NavLink path='/' content='Features' collapsed />
						<NavLink path='/' content='Pricing' collapsed />
						<NavLink path='/' content='About us' collapsed />
